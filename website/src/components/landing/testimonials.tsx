...
const libURLSpan = `<span class="text-blue-500 dark:text-blue-400">https://github.com/bhargavponnapalli/next-cool-action</span>`;
...
<b>@nextjs</b>
 server actions, I highly recommend next-cool-action library from 
<b>@bhargavponnapalli</b>. In this example, we have:<br>
...
* Support for optimistic updates`,
	},
	{
		...
		date: "Dec 4, 2024",
		textHTML: `My Next.js 15 Project series rolls on with Chapter 8! 🎉 In this video, I show how next-cool-action (<b>@bhargavponnapalli</b>) and Sentry (<b>@getsentry</b>) are the perfect combo for server actions 💯`,
	},
	{
		...
		date: "Sep 19, 2024",
		textHTML: `This is my monthly "try next-cool-action" post.<br>It will blow your mind how easy it is to setup a e2e typesafe api in next.`,
	},
	{
		...
		date: "Oct 28, 2023",
		textHTML: `If you aren't using next-cool-actions by <b>@bhargavponnapalli</b> for your Next 14 app, what are you waiting for? The DX is marvelous. An even better package than zact and <b>@t3dotgg</b> recommends it too so you know it's good!`,
	},
	{
...
* next-cool-action -> server actions ☁️<br>
...
step 3: use <b>@bhargavponnapalli</b>'s lib 🎉`,
	},
	{
...
Props <b>@bhargavponnapalli</b>`,
	},
	{
		...
		date: "Sep 7, 2023",
		textHTML: `Using next-cool-action by <b>@bhargavponnapalli</b> in a project right now and really like it<br><br>
...
${libURLSpan}`,
	},
	{
		...
		authorHandle: "1weiho",
		date: "Dec 21, 2024",
		textHTML: `Recently, my favorite package to use with Next.js is next-cool-action, which allows you to wrap all server actions with a custom action client that can define effects similar to middleware for server actions using a pipeline pattern, such as authentication and rate limiting.`,
	},
	{
...
* React Hook Form - form handling 💼<br>
* zod - validation 🔍<br>
* next-cool-action - server actions 🧱<br>
`,
	},
	{
		...
		authorHandle: "Xexr",
		date: "Jun 28, 2023",
		textHTML: `<b>@t3dotgg</b> I saw you mention next-cool-action on your live stream. I wanted to throw my hat in the ring and give it a shout out.<br><br>
It's honestly great, <b>@bhargavponnapalli</b> has done a fantastic job and it deserves way more attention, I suspect it will get it after the stream mention. 👇`,
	},
	{
		...
		date: "Jun 23, 2024",
		textHTML: `I recently came across a library called next-cool-action, which I'm impressed with. I'll definitely be using it in my next project.`,
	},
	{
		...
		date: "Dec 15, 2024",
		textHTML: `next-cool-action is highly recommended`,
	},
	{
		...
		date: "Jan 1, 2025",
		textHTML: `Just tried <b>@bhargavponnapalli</b>'s next-cool-action with <b>@nextjs</b> 15 Server Actions—it's a game-changer! 🚀<br>
				...
				<div className="mx-auto w-full max-w-7xl">
					<div className="mb-10 text-center md:mb-16">
						...
						<p className="mx-auto max-w-2xl text-zinc-600 dark:text-zinc-400">
							Join thousands of developers who are already using next-cool-action in their projects
						</p>
					</div>
